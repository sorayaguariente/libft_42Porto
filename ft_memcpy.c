...
/*   Updated: 2022/11/07 15:32:41 by sguarien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
/*
The  memcpy() function copies n bytes from memory area src to memory area dest.
The memory areas must not overlap.
(unsigned char *) is typecasted because this type occupies 1 byte, so it won't 
restrict this function and avoids const declaration
